...
START_BUTTON = [
    ...
    [
        Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/+ub0nytC5h-FhMzc9"),
        Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/+ub0nytC5h-FhMzc9")
    ],
    [
...
async def start(event):              
    if event.is_private:
        ...
        TEXT += f"» ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ : [𝗥𝗘𝗩𝗘𝗡𝗚𝗘 𝗞𝗜𝗡𝗚](https://t.me/REVENGEKING199)\n\n"
